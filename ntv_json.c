 ...
 */
static void
ntv_json_write(const ntv *msg, htsbuf_queue_t *hq, int indent, int pretty)
{
  ntv *f;
  char buf[100];
 ...
 */
void
ntv_json_serialize(ntv *msg, htsbuf_queue_t *hq, int pretty)
{
 ...
 */
char *
ntv_json_serialize_to_str(ntv *msg, int pretty)
{
  htsbuf_queue_t hq;
  char *str;
